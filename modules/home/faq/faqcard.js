  ...
  return (
    <>
      <ul className="my-5">
        ...
        <div
          className={`d-flex justify-content-between my-1 ${styles.mobilefaqs}`}
        >
          <div>
            <Image src={vector} alt="star" width={"20px"} height={"14px"} />
        ...
        >
          ...
          <div>
            <Image src={vector} alt="star" width={"20px"} height={"14px"} />
            <span className="m-3"> Many Wed Tamplates</span>
          </div>
          <div>
            <Image src={vector} alt="star" width={"20px"} height={"14px"} />
            <span className="m-3"> Hastle Free Registration</span>
