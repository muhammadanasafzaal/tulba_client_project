...
const SpecialEvent = () => {
  ...
  return (
    <div
      ...
      className="bg-[#F85757] text-white  h-[850px] flex flex-col justify-evenly items-center lg:hidden"
    >
      ...
      <div>
        <div className="bg-[#253659] py-3 px-8 rounded-xl cursor-pointer hover:shadow-xl" onClick={handelOpenModal} >
