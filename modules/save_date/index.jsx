        ...
        <Row>
          ...
          <Col lg={6} className={`mt-4 ${styles.save_date}`}>
            <div className="d-flex justify-content-start">
              ...
              <h2>
                {" "}
                <i className="mx-2"> Save the Date</i>{" "}
              </h2>
            </div>
            <p className={styles.head}>
              Double Check all your text and images before we print it for you.
            </p>
            ...
            <div className={styles.box}>
              ...
              <p>
                your purchase comes with the free changes in the date if you
                need them in any circumstances
              </p>
              <p className="mt-4">
            ...
            <div className={styles.total_box}>
              ...
              <div className="d-flex">
                ...
                <div>
                  <span>
                    All my text, date and imnformation and correct , and i am
                    ready to print my work.
                  </span>
                </div>
              </div>
            ...
            <div className="d-flex justify-content-start">
              ...
              <div className={`mx-3 ${styles.mail}`}>
                ...
                <p>
                  ...
                  <a href="mailto: TulbaWeds@gmail.com">TulbaWeds@gmail.com</a>
                </p>
              </div>
            </div>
          </Col>
